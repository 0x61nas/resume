...
Software engineer with 7+ years of experience, specializing in C, C++, Zig, Rust, Python, Java, and Jakarta EE. Proficient in Actix, FastAPI, Spring Boot, Git, Docker, and Nix.
Deep expertise in Linux (Arch, NixOS, Gentoo) with a strong focus on low-level system details and assembly-level optimization.
Passionate open-source contributor with a strong commitment to the Linux and tech communities.
Skilled in building innovative solutions and adapting to new technologies.
