...
\fancypagestyle{last-page}{
	\fancyfoot[C]{\tiny{Built on @{BUILDING_PLATFORM} from revision \href{https://github.com/0x61nas/resume/tree/@{GIT_HASH}}{@{GIT_HASH}} on \today{} with @{PDFLATEX_VERSION}}}% Centre footer
}
