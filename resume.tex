...
\section{Experience}
  ...
  \resumeItemListStart
    \resumeItem{Developing and maintaining the Transaction Middleware for our banking clients using Jakarta EE}
  ...
  \resumeItemListEnd
     ...
     \resumeSubheading
       ...
       \resumeItemListStart
         \resumeItem{Developed a REST APIs using Rust with Actix framework and PostgreSQL to store data from learning management systems}
       ...
       \resumeItemListStart
         ...
         \resumeItem{Developed a full-stack web application using Spring Boot, PostgreSQL, and Docker}
       \resumeItemListEnd
    \resumeSubHeadingListEnd
